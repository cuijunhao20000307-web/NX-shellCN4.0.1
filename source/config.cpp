...
namespace Config {
    ...
    int Load(void) {
        ...
        // Reset old configurations so this Chinese build always starts in Simplified Chinese.
        ...
        // Pin this dedicated build to Simplified Chinese even if an older English setting exists.
        if (cfg.lang != 6) {
            cfg.lang = 6;
            return Config::Save(cfg);
        }
